...
//
// Caveat: google.com and goo.gl are broad hosts, not narrow single-purpose
// ones. `endsWith('.google.com')` matches every Google subdomain, and
// google.com/url?q=... plus goo.gl are open redirectors that yt-dlp will
// happily follow to an arbitrary destination. This allowlist narrows SSRF
// surface to "an attacker must find an open redirect or vulnerability on a
// Google-owned host" — it does not eliminate it.
